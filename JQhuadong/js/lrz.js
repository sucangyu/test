...
function(e) {
        ...
        return new o(function(t, r) {
            ...
            n.onload = function() {
                e._getBase64().then(function(e) {
                    return e.length < 10 && r("生成base64失败"),
                    e
                }).then(function(n) {
                    t({
                        origin: e.file,
    ...
    r.prototype._getBase64 = function() {
        ...
        return new o(function(r) {
            a.getData(t,
            function() {
                e.orientation = a.getTag(this, "Orientation"),
                e.resize = e._getResize(),
                e.ctx = n.getContext("2d"),
                n.width = e.resize.width,
                n.height = e.resize.height,
                e.ctx.fillStyle = "#fff",
                e.ctx.fillRect(0, 0, n.width, n.height),
                s ? e._createBase64ForOldIOS().then(r) : e._createBase64().then(r)
            })
        })
    },
        ...
        return new o(function(o) {
            ...
            function(n) {
                var a = [n(5)]; (function(n) {
                    ...
                    o(r.toDataURL("image/jpeg", e.defaults.quality))
                }).apply(null, a)
            })
        })
    },
    r.prototype._createBase64 = function() {
        ...
        case 3:
            ...
            a.drawImage(r, -t.width, -t.height, t.width, t.height);
            break;
        case 6:
            a.rotate(90 * Math.PI / 180),
            a.drawImage(r, 0, -t.width, t.height, t.width);
            break;
        case 8:
            a.rotate(270 * Math.PI / 180),
            a.drawImage(r, -t.height, 0, t.height, t.width);
            break;
        case 2:
    ...
    r.prototype._getResize = function() {
        ...
        return r && i ? s >= r / i ? a.width > r && (a.width = r, a.height = Math.ceil(r / s)) : a.height > i && (a.height = i, a.width = Math.ceil(i * s)) : r ? r < a.width && (a.width = r, a.height = Math.ceil(r / s)) : i && i < a.height && (a.width = Math.ceil(i * s), a.height = i),
        (a.width >= 3264 || a.height >= 2448) && (a.width *= .8, a.height *= .8),
        a
    },
    window.lrz = function(e, t) {
        return new r(e, t)
    },
    window.lrz.version = "4.1.3",
...
function(e, t, r) {
    var i, o; (function() {
        ...
        function c(e) {
            ...
            if (m && console.log("Got file of length " + e.byteLength), 255 != t.getUint8(0) || 216 != t.getUint8(1)) return m && console.log("Not a valid JPEG"),
            !1;
            for (var n, r = 2,
            i = e.byteLength; i > r;) {
                if (255 != t.getUint8(r)) return m && console.log("Not a valid marker at offset " + r + ", found: " + t.getUint8(r)),
                !1;
                if (n = t.getUint8(r + 1), m && console.log(n), 225 == n) return m && console.log("Found 0xFFE1 marker"),
                p(t, r + 4, t.getUint16(r + 2) - 2);
                r += 2 + t.getUint16(r + 2)
            }
        }
        function l(e) {
        ...
        function h(e, t, n) {
            ...
            l = t; t + n > l;) 28 === u.getUint8(l) && 2 === u.getUint8(l + 1) && (a = u.getUint8(l + 2), a in F && (o = u.getInt16(l + 3), s = o + 5, i = F[a], r = g(u, l + 5, o), c.hasOwnProperty(i) ? c[i] instanceof Array ? c[i].push(r) : c[i] = [c[i], r] : c[i] = r)),
            l++;
            return c
        }
        function d(e, t, n, r, i) {
            ...
            a = r[e.getUint16(o, !i)],
            !a && m && console.log("Unknown tag: " + e.getUint16(o, !i)),
            c[a] = f(e, o, t, n, i);
            return c
        }
        function f(e, t, n, r, i) {
            ...
            d = e.getUint32(t + 4, !i),
            f = e.getUint32(t + 8, !i) + n;
            switch (h) {
            case 1:
            case 7:
                if (1 == d) return e.getUint8(t + 8, !i);
                for (o = d > 4 ? f: t + 8, a = [], u = 0; d > u; u++) a[u] = e.getUint8(o + u);
                return a;
            case 2:
                return o = d > 4 ? f: t + 8,
                g(e, o, d - 1);
            case 3:
                ...
                for (o = d > 2 ? f: t + 8, a = [], u = 0; d > u; u++) a[u] = e.getUint16(o + 2 * u, !i);
                return a;
            case 4:
                if (1 == d) return e.getUint32(t + 8, !i);
                for (a = [], u = 0; d > u; u++) a[u] = e.getUint32(f + 4 * u, !i);
                return a;
            case 5:
                if (1 == d) return c = e.getUint32(f, !i),
                l = e.getUint32(f + 4, !i),
                s = new Number(c / l),
                s.numerator = c,
                s.denominator = l,
                s;
                for (a = [], u = 0; d > u; u++) c = e.getUint32(f + 8 * u, !i),
                l = e.getUint32(f + 4 + 8 * u, !i),
                a[u] = new Number(c / l),
                a[u].numerator = c,
                a[u].denominator = l;
                return a;
            case 9:
                ...
                for (a = [], u = 0; d > u; u++) a[u] = e.getInt32(f + 4 * u, !i);
                return a;
            case 10:
                if (1 == d) return e.getInt32(f, !i) / e.getInt32(f + 4, !i);
                for (a = [], u = 0; d > u; u++) a[u] = e.getInt32(f + 8 * u, !i) / e.getInt32(f + 4 + 8 * u, !i);
                return a
            }
        }
        function g(e, t, r) {
        ...
        function p(e, t) {
            if ("Exif" != g(e, t, 4)) return m && console.log("Not valid EXIF data! " + g(e, t, 4)),
            !1;
            var n, r, i, o, a, s = t + 6;
            if (18761 == e.getUint16(s)) n = !1;
            else {
                if (19789 != e.getUint16(s)) return m && console.log("Not valid TIFF data! (no 0x4949 or 0x4D4D)"),
                !1;
                n = !0
            }
            if (42 != e.getUint16(s + 2, !n)) return m && console.log("Not valid TIFF data! (no 0x002A)"),
            !1;
            var u = e.getUint32(s + 4, !n);
            if (8 > u) return m && console.log("Not valid TIFF data! (First offset less than 8)", e.getUint32(s + 4, !n)),
            !1;
            if (r = d(e, s, s + u, y, n), r.ExifIFDPointer) {
                o = d(e, s, s + r.ExifIFDPointer, v, n);
                for (i in o) {
                    switch (i) {
                    case "LightSource":
                    case "Flash":
            ...
            if (r.GPSInfoIFDPointer) {
                a = d(e, s, s + r.GPSInfoIFDPointer, S, n);
                for (i in a) {
                    switch (i) {
                    case "GPSVersionID":
        ...
        "undefined" != typeof e && e.exports && (t = e.exports = w),
        t.EXIF = w;
        var v = w.Tags = {
            36864 : "ExifVersion",
